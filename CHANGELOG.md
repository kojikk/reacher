...
- Clarified the Tailscale status tool description to note that the API sometimes reports devices as offline.
...
[0.2.1]: https://github.com/kojikk/reacher/releases/tag/v0.2.1
[0.1.0]: https://github.com/kojikk/reacher/releases/tag/v0.1.0
